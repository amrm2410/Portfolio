...
import { CONTACT_INFO, SOCIAL_LINKS, CONTACT_FORM_TITLE, CONTACT_INFO_TITLE, CONTACT_INFO_DESCRIPTION, SOCIAL_TITLE } from '@/constants/contact';
import './Contact.css';
...
const Contact = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      await fetch(scriptURL, { method: 'POST', mode: 'no-cors', body: data });
            ...
            <div className="bento-card contact-form-card">
              ...
              <form className="contact-form" onSubmit={handleSubmit}>
                ...
                <div className="form-group">
                  ...
                  <input type="tel" id="phone" name="phone" placeholder="+1 (555) 123-4567" value={formData.phone} onChange={handleChange} required />
                </div>

                <div className="form-group">
                  <label htmlFor="project">Project Details</label>
                  <textarea id="project" name="project" rows={5} placeholder="Tell me about your project requirements, timeline, and budget..." value={formData.project} onChange={handleChange} required />
                </div>
            ...
            <div className="bento-card social-media-card">
              ...
              <div className="social-links">
                {SOCIAL_LINKS.map((social) => (
                  <a key={social.platform} href={social.url} target="_blank" rel="noopener noreferrer" className="social-link">
